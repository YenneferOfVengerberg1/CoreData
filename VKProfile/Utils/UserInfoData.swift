...
class UserInfoData {
    ...
    private static let names = ["Felix", "Anomaly", "Leo", "Legasov", "John", "Dany"]
    private static let surnames = ["Kjelberg", "Fat", "DeCaprio", "Sherbina", "Snow", "Targaryen"]
    private static let cities = ["Kirov", "New York", "Washington", "Moscow", "Saint Petersburg", "Berlin"]
    ...
    private static let profilePhotos = [#imageLiteral(resourceName: "album5"), #imageLiteral(resourceName: "avatar2"), #imageLiteral(resourceName: "avatar3"), #imageLiteral(resourceName: "avatar4"), #imageLiteral(resourceName: "avatar5"), #imageLiteral(resourceName: "avatar6")]
    
    private static let statuses = ["I ❤️ swift programming", "I ❤️ java programming", "I ❤️ Android programming", "I ❤️ iOS programming", "I ❤️ VYATSU", "I ❤️ learn programming", ""]
    private static let universities = ["VYATSU", "MIT", "YEL", "MSU", "PHISTEH", "LOMONOSOVSU"]
    ...
    private static let directions = ["Информационные технологии", "Прикладная математика и информатика", "Прикладная математика и информатика", "Физика", "Экономика", "SPORTFAK"]
    private static let schools = ["Cialkovskogo number 10", "46 school", "28 school", "first school", "second school", "third school"]
    private static let schoolDirections = ["physics and math", "meth and math", "computer scince", "math", "language", "cultural"]
    private static let companies = ["elma", "vyatsu", "globus", "uni gym", "digital tech", "citycom"]
    private static let professions = ["Back end", "fron end", "Digital Strategy", "ERP", "GR", "HR"]
